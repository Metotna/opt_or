<template>
  <div>
    ...
    <div style="padding:10px;" class='order_table'>
      <el-table :data="tableData" border style="font-size: 13px;"  show-summary :summary-method="getSummaries" v-loading="vloadFlag" element-loading-text="拼命加载中">
      ...
      <el-dialog title="订单详情" :visible.sync="dialogTableVisible" style='width:1364px;'>
        <!-- 竞彩 -->
        <el-table :data="orderticket" style="width: 100%" border  class='tickcot'>
          ...
          <el-table-column label="投注详情" width="150">
            <el-button-group slot-scope="scope">
          ...
          <el-table-column label="中奖状态" width="80">
            <el-button-group slot-scope="scope"> {{scope.row.awardResult|order-result}}</el-button-group>
          </el-table-column>
          <el-table-column label="出票状态" width="80">
            <el-button-group slot-scope="scope"> {{tstatus(scope.row.ticketStatus)}}</el-button-group>
          </el-table-column>
          <el-table-column prop="ticketBetCount" label="注数" width="60">
          </el-table-column>
          <el-table-column prop="ticketBetDouble" label="倍数" width="60">
          </el-table-column>
          <el-table-column prop="ticketBetMoney" label="金额(¥)" width="70">
          </el-table-column>
        </el-table>
      </el-dialog>
      <div class="PagePilot">
